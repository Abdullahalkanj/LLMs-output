  ...
  public void addBoatFromUserInput(String memberId) {
    ...
    if (type == BoatType.SAILBOAT || type == BoatType.MOTORSAILER) {
        ...
        try {
            ...
            System.out.println("Please enter a valid integer for depth.");
            return;
        }
    }
    ...
    if (type == BoatType.MOTORBOAT || type == BoatType.MOTORSAILER) {
        ...
        // —— Validate enginePower here ——
        try {
            enginePower = Integer.parseInt(scanner.nextLine().trim());
        } catch (NumberFormatException e) {
            System.out.println("Please enter a valid integer for engine power.");
            return;
        }
    }
