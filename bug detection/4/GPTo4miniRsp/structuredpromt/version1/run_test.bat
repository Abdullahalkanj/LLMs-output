...
set CP=lib\junit-4.13.2.jar;lib\hamcrest-core-1.3.jar;4\GPTo4miniRsp\structuredpromt\version1;4\GPTo4miniRsp\test

javac -cp %CP% ^
  4\GPTo4miniRsp\structuredpromt\version1\HANOI.java ^
