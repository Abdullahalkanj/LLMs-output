...
set CP=lib\junit-4.13.2.jar;lib\hamcrest-core-1.3.jar;4\GPTo4miniRsp\chain-of-thought\version3;4\GPTo4miniRsp\test

javac -cp %CP% ^
  4\GPTo4miniRsp\chain-of-thought\version3\HANOI.java ^
