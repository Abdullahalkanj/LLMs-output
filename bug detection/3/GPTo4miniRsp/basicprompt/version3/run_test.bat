...
set CP=lib\junit-4.13.2.jar;lib\hamcrest-core-1.3.jar;3\GPTo4miniRsp\basicprompt\version3;3\GPTo4miniRsp\test

javac -cp %CP% ^
  3\GPTo4miniRsp\basicprompt\version3\SIEVE.java ^
