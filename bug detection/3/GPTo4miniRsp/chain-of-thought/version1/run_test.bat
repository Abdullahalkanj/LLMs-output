...
set CP=lib\junit-4.13.2.jar;lib\hamcrest-core-1.3.jar;3\GPTo4miniRsp\chain-of-thought\version1;3\GPTo4miniRsp\test

javac -cp %CP% ^
  3\GPTo4miniRsp\chain-of-thought\version1\SIEVE.java ^
