...
program_to_test = os.path.join(BASE_DIR, 'GPTo4miniRsp', 'chainofthoughtprompt', 'version1', 'excode.py')
in_folder  = os.path.join(BASE_DIR, 'C', 'in')
out_folder = os.path.join(BASE_DIR, 'C', 'out')
timeout_sec = 10
